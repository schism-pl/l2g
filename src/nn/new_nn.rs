...
impl<'a> FLLMegastepIter<'a> {
    fn new(nn: NN, protocol: &'a SynthesisProtocol) -> Self {
        Self {
            nn,
            t: 0.0,
            protocol,
...
impl<'a> Iterator for FLLMegastepIter<'a> {
...
impl<'a> ExactSizeIterator for FLLMegastepIter<'a> {
...
impl<'a> Peekable for FLLMegastepIter<'a> {
